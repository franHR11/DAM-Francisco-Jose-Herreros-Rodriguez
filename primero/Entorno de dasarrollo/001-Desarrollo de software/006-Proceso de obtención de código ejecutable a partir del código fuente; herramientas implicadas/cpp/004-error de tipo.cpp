...
int main(){											// Creo una funcion, pero es el punto de entrada de la ejecucion, la funcion devuelve un entero
	double edad =35;									// Creo una variable de tipo entero y le asigno un valor
    std::cout << "hola mundo desde C++";	// De la libreria estanda (std) quiero usar el comando C-out, y saco una cadena
