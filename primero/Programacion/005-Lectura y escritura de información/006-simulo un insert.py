...
print("Vamos a trabajar con la entidad:",tablas[int(opcion)])               # Comprobación de que todo va bien# Selecciona una opción
peticion = "SELECT * FROM "+tablas[int(opcion)]                        # Selecciono de forma dinámica todas las tablas de la base de datos
print("La peticion que voy a ejecutar es:",peticion)                     # Comprobación de que todo va bien
