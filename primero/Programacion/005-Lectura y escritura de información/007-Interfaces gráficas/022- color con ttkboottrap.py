...
import ttkbootstrap as tk  # Replace tkinter.ttk with ttkbootstrap
from ttkbootstrap.constants import *

ventana = tk.Window(themename="cosmo")                                               # Creo una nueva ventana
ventana.geometry("500x500")                                     # Le pongo dimensiones a la ventana
ventana.title("Calculadora v0.1 por Francisco Jose")                               # Le pongo un titulo a la ventana
