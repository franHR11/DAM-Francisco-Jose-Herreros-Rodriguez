...
class BloqueTienda extends Bloque {
    ...
    public function getBloque() {
        ...
        foreach($productos as $producto) {
            ...
            // Crear el contenedor del producto sin enlace
            $html .= "
                <div class='producto'>
        ...
        // Actualizar los estilos para trabajar con div en lugar de <a>
        $html .= "
        <style>
            #".$this->uniqueId." .producto-contenido {
                display: block;
                transition: transform 0.2s ease;
                text-decoration: none;
                color: inherit;
            }
            #".$this->uniqueId." .producto-contenido:hover {
                transform: translateY(-5px);
            }
            #".$this->uniqueId." .producto {
                display: flex;
