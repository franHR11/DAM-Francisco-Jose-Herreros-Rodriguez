const jocarsaSnow = {
    createEditor: function (textarea) {
        // Verificar si el editor ya está inicializado para este textarea
        if (textarea.closest('.jocarsa-snow-editor-container')) {
            return; // Si ya existe un contenedor padre, salir
        }

        // Continuar con la inicialización solo si no existe
