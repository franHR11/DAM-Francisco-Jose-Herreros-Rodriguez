...
class JVAnaliticas:
    def __init__(self):
        ...
        db_path = os.path.join(current_dir, '..', 'front', 'logs.sqlite')
        # Construir la ruta absoluta para la carpeta de imágenes
        self.img_path = os.path.join(current_dir, 'imagenes')
    ...
    def graficaTarta(self,peticion, salida,titulo):
        ...
        plt.savefig(os.path.join(self.img_path, salida))
