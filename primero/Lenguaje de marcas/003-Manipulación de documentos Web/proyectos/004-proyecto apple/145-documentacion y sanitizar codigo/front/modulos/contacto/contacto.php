<?php
/**
 * @webblock Formulario de contacto
 * @author FranHR
 * @description Módulo de contacto con formulario y mapa integrado
 * @version 1.0.0
 */
?>
<main>
    <div id="contacto">
        <div id="formulario">
            ...
            <input type="text" id="asunto" placeholder="Introduce el asunto de tu correo">
            ...
            <div class="seguridad">
                ...
                <input type="number" id="dobledia" placeholder="Indica el doble del día de hoy">
        ...
        <iframe 
            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d6161.030693592611!2d-0.413553896997941!3d39.474927982455256!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2ses!4v1733843524043!5m2!1ses!2ses" 
            width="600" 
            height="550" 
            loading="lazy" 
