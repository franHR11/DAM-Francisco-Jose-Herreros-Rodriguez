...
<main class="contenedor seccion">
    ...
    <div class="admin-header con-busqueda">
        <div class="botones-accion">
            ...
            <a href="<?php echo url('/admin/blog/categorias/crear.php'); ?>" class="boton boton-verde">Nueva Categoría</a>
        </div>
    ...
    <div class="admin-categorias-grid">
            ...
            <?php foreach ($categorias as $categoria) : ?>
                <div class="categoria-card">
                    ...
                    <div class="categoria-card__footer">
                        <div class="acciones">
                            <a href="<?php echo url('/admin/blog/categorias/actualizar.php?id=' . $categoria->id); ?>" class="boton boton-amarillo">Editar</a>
