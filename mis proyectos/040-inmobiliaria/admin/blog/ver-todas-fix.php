...
// Este archivo debe copiarse a admin/blog/ver-todas/index.php solo si el original no funciona
...
<main class="contenedor seccion">
    ...
    <div class="admin-header con-busqueda">
        <div class="botones-accion">
            ...
            <a href="../crear.php" class="boton boton-verde">Nueva Entrada</a>
        </div>
                ...
                <div class="entrada-blog-admin">
                    <div class="imagen-blog-admin">
                        <?php if($entrada->imagen): ?>
                            <img src="../../imagenes/<?php echo $entrada->imagen; ?>" alt="Imagen del artículo">
                        <?php else: ?>
                    ...
                    <div class="contenido-blog">
                        ...
                        <div class="acciones-entrada">
                            <a href="../actualizar.php?id=<?php echo $entrada->id; ?>" class="boton boton-amarillo">Editar</a>
